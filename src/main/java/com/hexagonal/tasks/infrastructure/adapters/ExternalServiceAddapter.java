...
public class ExternalServiceAddapter implements ExternalServicePort {

    private final RestTemplate restTemplate;

    public ExternalServiceAddapter() {
    ...
    public AdditionalTaskInfo getAdditionalTaskInfo(Long taskId) {
        ...
        ResponseEntity<JsonPlaceHolderUser> userResponce =restTemplate.getForEntity(apiUrl, JsonPlaceHolderUser.class);
        JsonPlaceHolderUser user = userResponce.getBody();
        if(user == null){
            return null;
        }
